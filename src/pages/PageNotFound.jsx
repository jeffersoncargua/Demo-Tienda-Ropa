...
export const PageNotFound = () => {
	...
	return (
		<div className="w-[90%] md:w-[80%] min-h-full my-20 flex flex-col justify-center space-y-10 mx-auto">
			<span className="font-extrabold text-7xl md:text-9xl text-center text-shadow-lg text-shadow-neutral-500 font-rubikDistressed">
				404 !
			</span>
			<span className="font-semibold text-2xl text-center text-shadow-lg/90 text-shadow-gray-400 underline decoration-4 underline-offset-8 decoration-purple-700">
				No se encontró el recurso solicitado. Inténtelo nuevamente
			</span>
			<button
				type="button"
				onClick={() => navigate("/")}
