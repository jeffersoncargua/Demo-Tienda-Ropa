...
export const EmptyCart = () => {
	...
	return (
		<div className="w-full flex items-center">
			<div className="w-[80%] sm:w-[70%] md:w-[60%] mx-auto bg-gray-500 flex flex-col my-5 space-y-5 rounded-lg shadow-lg shadow-black">
				<svg
				...
				<button
					type="button"
					onClick={() => navigate("/")}
					className="flex flex-row items-center mx-auto rounded-lg mb-5 bg-amber-500 text-xs md:text-sm px-2 py-1.5 hover:text-white"
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						fill="currentColor"
