		...
		<div className="w-[95%] flex flex-col mx-auto my-10 space-y-10">
			...
			{shoppingCart.length > 0 && (
				<div className="flex flex-row items-center justify-center md:justify-end space-x-4 text-xs md:text-sm">
					<Link
						to={"/order"}
						className="bg-green-600 hover:bg-green-700 hover:text-white rounded-lg flex flex-col sm:flex-row justify-center items-center px-5 py-2  hover:border-2 hover:border-black font-semibold"
					>
						Ir a Pagar: &nbsp;
						<span className="flex flex-row items-center mt-2 sm:mt-0">
							${total.toFixed(2)}
							<svg
								xmlns="http://www.w3.org/2000/svg"
								fill="currentColor"
					...
					<Link
						to={"/"}
						className="bg-yellow-300 hover:bg-yellow-600 hover:text-white rounded-lg flex flex-col sm:flex-row justify-center items-center px-5 py-2  hover:border-2 hover:border-black font-semibold"
					>
						Seguir &nbsp;
						<span className="flex flex-row items-center mt-2 sm:mt-0">
							Comprando
