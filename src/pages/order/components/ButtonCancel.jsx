...
import { SweetAlertDelete, SweetAlertSuccessDeleted } from "../../../components/SweetAlertResponse";
import { clearToCart } from "../../../redux/cartSlice";
import { useNavigate } from "react-router";

export const ButtonCancel = ({identificacion = "", token = "", tipo = ""}) => {
    ...
    switch (tipo) {
        ...
        default:
            styleClass = "px-5 py-2 bg-red-400 hover:bg-red-600 rounded-lg hover:text-white flex flex-row justify-center items-center hover:border-2 hover:border-black";
            break;
    }
